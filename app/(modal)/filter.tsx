...
const Filter = () => {
    ...
    useEffect(() => {
        ...
        const selectedItems = items.filter(items => items.checked);
    ...
    const renderItem: ListRenderItem<Category> = ({ item, index }) => (
        <View style={styles.row}>
            ...
            <BouncyCheckbox disableBuiltInState fillColor={Colors.primary} unfillColor={Colors.white} iconStyle={{ borderColor: Colors.primary, borderRadius: 4, borderWidth: 2 }} innerIconStyle={{ borderColor: Colors.primary, borderRadius: 4 }} onPress={() => {
